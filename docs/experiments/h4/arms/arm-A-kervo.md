...
**[generated — backend:gpt-oss-120b]**
...
- **[stale — superseded by code change: settlement moved to Kafka (queue/kafka.go, June 2026)]** Settlement jobs go through the legacy RabbitMQ queue (settlement_jobs); new consumers should bind there. _(system)_
